...
# === Data file aur lock time setting ===
...
if choice == "Home":
    ...
    st.markdown("""
        ...
        - Decrypt your data anytime with the same key
        - Protects against brute-force with lockout
        - Uses local file storage only (no external DB)
    """)
